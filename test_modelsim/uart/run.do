...
vlog -sv -cover sbcexf +incdir+. model/clk_gen.sv model/uart_rx.sv model/uart_tx.sv model/uart.sv  tb.sv

# === 2. Load simulation with coverage ===
# Testbench top: Module name into testbench file
vsim -voptargs=+acc -coverage +UVM_NO_RELNOTES +UVM_VERBOSITY=UVM_LOW tb
